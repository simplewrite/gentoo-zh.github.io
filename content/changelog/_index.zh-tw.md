...
- 6.4 節「配置 fstab」大幅完善：補充「為什麼需要這一步？」說明，加入 genfstab 自動產生（含引數說明、chroot/LiveGUI/TTY 場景）、手動編輯方法，並提供 Btrfs 子卷與 LUKS 加密分割槽範例
- 將 fstab 相關內容以 `<details>` 摺疊重排，降低章節長度壓力
- 8.1 節「系統服務工具」將 OpenRC / systemd 使用者分別摺疊，提升可讀性
...
**網站語言與術語更新**
- 語言選擇器顯示名稱從「傳統中文」改為「傳統中文」，從「簡體中文」改為「簡化中文」
- 首頁「新聞」標題改為「文章」
...
- 最佳化 5.2 節「make.conf 範例」的懶人配置，為每個引數新增詳細註釋說明
...
**網站基礎設施**
- 修復貢獻者自動更新後網站未重新部署的問題（移除提交資訊中的 `[skip ci]` 標記）
- 更新 Blowfish 主題至最新版本
- 新增本更新記錄頁面
