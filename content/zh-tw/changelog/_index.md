...
- **gentoo-zh overlay 倉庫遷到組織倉庫 [Gentoo-zh/gentoo-zh](https://github.com/Gentoo-zh/gentoo-zh)**：舊的 `microcai/gentoo-zh` 會 301 到新倉庫，已新增的使用者請把同步源更新到新 URL，詳見[倉庫遷移公告與執行方案](/posts/2026-07-02-gentoo-zh-repo-migration/)
