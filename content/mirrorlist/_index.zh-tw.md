...
**配置參考文件：**
- 倉庫配置：<https://wiki.gentoo.org/wiki//etc/portage/repos.conf>
- Distfiles 鏡像配置：<https://wiki.gentoo.org/wiki/GENTOO_MIRRORS>
...
1. **使用 emerge-webrsync**：Portage 會從 Distfiles 下載每日歸檔的 Portage 壓縮檔進行同步。
