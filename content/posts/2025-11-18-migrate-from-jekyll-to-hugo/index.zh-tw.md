...
- **構建速度快**：Hugo 使用 Go 編寫，構建速度比 Jekyll 快數十倍
- **無需 Ruby 環境**：Hugo 是單一二進位制檔案，部署更簡單
- **記憶體佔用低**：大型站點構建時資源消耗更少

### 功能特性

- **內建多語言支援**：原生支援簡體中文和傳統中文
- **強大的主題系統**：採用 Blowfish 主題，介面現代美觀
- **更好的資源管理**：支援圖片最佳化、CSS/JS 打套件等
...
新增和完善的頁面：
- **下載頁面**：列出官方和中國內陸映象源，特別標註 Apple Silicon Mac 使用者注意事項
- **映象列表**：詳細的 Portage 樹和 Distfiles 配置說明
- **Overlay 檔案**：gentoo-zh overlay 使用指南
- **關於頁面**：專案歷史和團隊介紹
